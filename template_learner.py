...
''' 
============================== READ THIS !!!!!! ======================================
If this is the template learner, DO NOT MAKE CHANGES TO THIS MODULE UNLESS DISCUSSED WITH TEAM MEMBERS 
make a copy and change that instead
'''
...
def main(): 
    while(True): # keeps prompting for and train on data 
        ...
        # ========================================================================= 
        # now clip list is loaded data as a list of clips, if you are to use this module, make changes after this part 
        # because our first goal is to get accuracies in percentages, that is all your module needs to print out
        # =========================================================================== 
